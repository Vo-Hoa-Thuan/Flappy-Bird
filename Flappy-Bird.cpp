...
void updateScore(){
	gotoxy(WIN_WIDTH + 15, 8);cout<<"Score: "<<score<<endl;
}
...
void help(){
		...
		for(int i=3;i<SCREEN_HEIGHT-11;i++){
	...
	gotoxy(35,5);  cout <<"- Press spacebar to make bird fly";   TextColor(3);
	gotoxy(35,6);  cout <<"- Press any key to go back to menu";	 TextColor(3); 
	getch();
}
...
void play(){
	...
	gotoxy(WIN_WIDTH + 15, 16); TextColor(11);  cout<<"Control ";
	gotoxy(WIN_WIDTH + 14, 17); TextColor(11);  cout<<"---------";
	gotoxy(WIN_WIDTH + 10, 18); TextColor(11);  cout<<" Spacebar = jump";
